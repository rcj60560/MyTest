...
public class IOUtils {
    ...
    public static byte[] toByteArray(Object input) {
        ...
        try {
            ...
            com.lzy.okgo.utils.IOUtils.closeQuietly(oos);
            com.lzy.okgo.utils.IOUtils.closeQuietly(baos);
        }
        return null;
    }
    ...
    public static Object toObject(byte[] input) {
        ...
        try {
            ...
            com.lzy.okgo.utils.IOUtils.closeQuietly(ois);
            com.lzy.okgo.utils.IOUtils.closeQuietly(bais);
        }
        return null;
    }
